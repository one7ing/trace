...
CREATE INDEX IF NOT EXISTS idx_memories_source_type ON long_term_memories(user_id, source_type);
CREATE INDEX IF NOT EXISTS idx_memories_user_created ON long_term_memories(user_id, created_at DESC);
